var AssistantIssues = (function () {

    var _options = {};

    // constructor
    function AssistantIssues(options) {
        _options = options;
    };

    AssistantIssues.prototype.getOptions = function () {
        return _options;
    };

    AssistantIssues.prototype.setOptions = function (options) {
    ...
    AssistantIssues.prototype.fetchByUser = function ( page ) {
        ...
        $.ajax({
            ...
            dataType: "json",
            async: true,
            url: '/user/fetchMyAssistantIssues',
