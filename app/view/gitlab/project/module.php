                                ...
                                <li class="flex-row">
                                    <div class="row-main-content str-truncated">
                                        ...
                                        <span class="item-title">
                                            <i class="fa fa-tag"></i>v1.2</span></a>
...
Select Archive Format
                                ...
                                <li class="flex-row">
                                    <div class="row-main-content str-truncated">
                                        <a href="/ismond/xphp/tags/v1.0"><span class="item-title">
<i class="fa fa-tag"></i>
v1.0
</span>
...
Select Archive Format
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-align-right" role="menu">
                                                <li class="dropdown-header">Source code</li>
                                                <li>
                                                    <a rel="nofollow" download="" href="/ismond/xphp/repository/archive.zip?ref=v1.0"><i class="fa fa-download"></i>
                                                        <span>Download zip</span>
                                                    </a></li>
                                                <li>
                                                    <a rel="nofollow" download="" href="/ismond/xphp/repository/archive.tar.gz?ref=v1.0"><i class="fa fa-download"></i>
                                                        <span>Download tar.gz</span>
                                                    </a></li>
                                                <li>
                                                    <a rel="nofollow" download="" href="/ismond/xphp/repository/archive.tar.bz2?ref=v1.0"><i class="fa fa-download"></i>
                                                        <span>Download tar.bz2</span>
                                                    </a></li>
                                                <li>
                                                    <a rel="nofollow" download="" href="/ismond/xphp/repository/archive.tar?ref=v1.0"><i class="fa fa-download"></i>
                                                        <span>Download tar</span>
                                                    </a></li>
                                            </ul>
                                        </div>
                                        <a class="btn has-tooltip" title="Edit release notes" data-container="body" href="/ismond/xphp/tags/v1.0/release/edit"><i class="fa fa-pencil"></i>
                                        </a><a class="btn btn-remove remove-row has-tooltip " title="Delete tag" data-confirm="Deleting the 'v1.0' tag cannot be undone. Are you sure?" data-container="body" data-remote="true" rel="nofollow" data-method="delete" href="/ismond/xphp/tags/v1.0"><i class="fa fa-trash-o"></i>
                                        </a></div>
                                </li>
