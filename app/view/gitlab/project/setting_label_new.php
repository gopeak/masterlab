        ...
        <div class="">
            <div class="content" id="content-body">
                ...
                <div class="container-fluid container-limited">
                    ...
                    <hr>
                    <form class="form-horizontal label-form js-quick-submit js-requires-input" id="form_add_action" action="<?=ROOT_URL?>project/label/add?project_id=<?=$project_id?>" accept-charset="UTF-8" method="post">
