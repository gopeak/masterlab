...
<head  >
    ...
    <script src="/dev/js/admin/issue_resolve.js" type="text/javascript" charset="utf-8"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="page-title">新增解决结果</h3>
            </div>
            <div class="modal-body">
                <form class="js-quick-submit js-upload-blob-form form-horizontal"  id="form_add" action="/admin/issue_resolve/add"   accept-charset="UTF-8" method="post">
...
<div class="modal" id="modal-issue_resolve_edit">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <a class="close" data-dismiss="modal" href="#">×</a>
                <h3 class="page-title">编辑解决结果</h3>
            </div>
            <div class="modal-body">
                <form class="js-quick-submit js-upload-blob-form form-horizontal" id="form_edit"  action="/admin/issue_resolve/update"   accept-charset="UTF-8" method="post">
