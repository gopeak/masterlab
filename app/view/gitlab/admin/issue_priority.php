...
<head  >
    ...
    <script src="/dev/js/admin/issue_priority.js" type="text/javascript" charset="utf-8"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="js-quick-submit js-upload-blob-form form-horizontal"  id="form_add" action="/admin/issue_priority/add"   accept-charset="UTF-8" method="post">
...
<div class="modal" id="modal-issue_priority_edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="js-quick-submit js-upload-blob-form form-horizontal" id="form_edit"  action="/admin/issue_priority/update"   accept-charset="UTF-8" method="post">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var options = {
            ...
            filter_url:"/admin/issue_priority/fetch_all",
            get_url:"/admin/issue_priority/get",
            update_url:"/admin/issue_priority/update",
            add_url:"/admin/issue_priority/add",
            delete_url:"/admin/issue_priority/delete",
