...
<head  >
    ...
    <script src="/dev/js/admin/issue_type.js" type="text/javascript" charset="utf-8"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="page-title">新增问题类型</h3>
            </div>
            <div class="modal-body">
                <form class="js-quick-submit js-upload-blob-form form-horizontal"  id="form_add" action="/admin/issue_type/add"   accept-charset="UTF-8" method="post">
...
<div class="modal" id="modal-issue_type_edit">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <a class="close" data-dismiss="modal" href="#">×</a>
                <h3 class="page-title">编辑问题类型</h3>
            </div>
            <div class="modal-body">
                <form class="js-quick-submit js-upload-blob-form form-horizontal" id="form_edit"  action="/admin/issue_type/update"   accept-charset="UTF-8" method="post">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var options = {
            ...
            filter_url:"/admin/issue_type/fetch_all",
            get_url:"/admin/issue_type/get",
            update_url:"/admin/issue_type/update",
            add_url:"/admin/issue_type/add",
            delete_url:"/admin/issue_type/delete",
