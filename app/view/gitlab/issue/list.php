...
<div class="page-with-sidebar">
                                ...
                                <div class="issues-other-filters filtered-search-wrapper">
                                    ...
                                    <div class="filter-dropdown-container">
                                        <div class="dropdown inline prepend-left-10" title="">
                                            ...
                                            <button class="dropdown-toggle" id="btn-go_search" type="button"
                                                    title="请求数据">
                                            ...
                                            <a class="btn btn-new js-key-create" data-target="#modal-create-issue"
                                               data-toggle="modal"
    ...
    <script type="text/html" id="main_children_list_tpl">
        ...
        <li class="commits-stat">
            {{user_html assignee}}
            <a href="<?= ROOT_URL ?>issue/detail/index/{{id}}" target="_blank" style="margin-left:5px;top: 3px;">#{{id}}
                {{summary}}
            </a>
