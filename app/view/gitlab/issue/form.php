...
<script type="text/html" id="multi_user_tpl">
    <div class="issuable-form-select-holder">
        ...
        >
            {{#project_users}}
                <option value="{{uid}}"  data-content="<img width='26px' height='26px' class=' float-none' style='border-radius: 50%;' src='/attachment/avatar/{{uid}}.png' data-original-title='master Master'> {{display_name}}"  {{#if_in_array uid ../edit_data}}selected{{/if_in_array}} >{{display_name}}</option>
            {{/project_users}}
