...
//                $panel_third.hide();
                $panel_second.html("");
                $panel_third.html("");
                _user_widgets.first = first_widgets.concat(second_widgets).concat(third_widgets);
                ...
                if (length1 > 1 && length2 === 0 && length3 === 0) {
                    $item_first.each(function (i) {
                        if (i >= length1/2) {
                            ...
                            $(this).remove();
                            _user_widgets.second = second_widgets.push(first_widgets[i]);
                            _user_widgets.first = first_widgets.splice(i, 1);
                        }
                    });
                } else if (length3 > 0) {
                    $panel_second.append($panel_third.html());
                    _user_widgets.second = second_widgets.concat(third_widgets);
                }
                ...
                if (length1 > 1 && length2 === 0 && length3 === 0) {
                    $item_first.each(function (i) {
                        if (i >= length1/3 && i < length1 * 2/3 ) {
                            $panel_second.append($(this).prop('outerHTML'));
                            second_widgets.push(first_widgets[i]);
                        ...
                        if (i >= i < length1 * 2/3) {
                            ...
                            third_widgets.push(first_widgets[i]);
                            first_widgets.splice(i, 1);
                    ...
                    $item_second.each(function (i) {
                        if (i >= length2/2) {
                            $panel_third.append($(this).prop('outerHTML'));
                            third_widgets.push(second_widgets[i]);
                            second_widgets.splice(i, 1);
                            _user_widgets.third = third_widgets;
                            _user_widgets.first = second_widgets;
                            $(this).remove();
                        }
                    });
