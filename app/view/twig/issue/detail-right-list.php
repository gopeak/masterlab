...
<div class="float-right-side">
    ...
    <script type="text/html" id="issuable-header_tpl">
        <h3 class="page-title">
            <span>{{issue.summary}}</span><a href="/issue/detail/index/{{issue.id}}" id="a_issue_key">#{{issue.pkey}}{{issue.id}}</a>
        </h3>
            ...
            <ul class="notes notes-form timeline">
                <li class="timeline-entry">
                    ...
                    <div class="timeline-content timeline-content-form">
                        <form data-type="json" class="new-note js-quick-submit common-note-form gfm-form js-main-target-form show" enctype="multipart/form-data" action="/issue/main/comment" accept-charset="UTF-8" data-remote="true" method="post">
