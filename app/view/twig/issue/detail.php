...
<head>
    ...
    <script src="/dev/lib/bootstrap-select/js/bootstrap-select.js" type="text/javascript"
    ...
    <link rel="stylesheet" href="/dev/css/issue/detail.css?v={{_version}}"/>
                                ...
                                <script type="text/html" id="issuable-header_tpl">
                                    ...
                                    <div class="issuable-meta">
                                        <strong class="identifier">事项
                                            <a href="/issue/detail/index/{{issue.id}}"
                                               id="a_issue_key">#{{issue.pkey}}{{issue.id}}</a></strong>
                                        由
                                        <strong>
                                            <a class="author_link  hidden-xs" href="/user/profile/{{issue.creator_info.uid}}">
                                            ...
                                            <a class="author_link  hidden-sm hidden-md hidden-lg" href="/user/profile/{{issue.creator_info.uid}}">
                                                ...
                                                <li class="timeline-entry">
                                                    ...
                                                    <div class="timeline-content timeline-content-form">
                                                        <form data-type="json"
                                                              ...
                                                              action="/issue/main/comment" accept-charset="UTF-8"
                    ...
                    <aside aria-live="polite" class="js-right-sidebar right-sidebar right-sidebar-expanded"
                        ...
                        <div class="issuable-sidebar">
                            ...
                            <form class="issuable-context-form inline-update js-issuable-update" id="edit_issue_1"
                                  action="/issue/main/patch" accept-charset="UTF-8" data-remote="true"
                                  method="post">
                                <input name="utf8" type="hidden" value="&#x2713;"/>
            ...
            <div class="timeline-entry-inner">
                ...
                <div class="timeline-content">
                    <div class="note-header">
                        <a class="visible-xs" href="/user/profile/{{user.uid}}">@{{user.username}}</a>
                        <a class="author_link hidden-xs " href="/user/profile/{{user.uid}}">
                    ...
                    <div class="js-task-list-container note-body is-task-list-enabled">
                        <form class="edit-note common-note-form js-quick-submit gfm-form"
                              action="/issue/detail/update_timeline/{{id}}" accept-charset="UTF-8"
                    ...
                    <div class="note-body">
                        ...
                        <div class="note-awards">
                            <div class="awards hidden js-awards-block"
                                 data-award-url="/issue/detail/timeline/{{id}}">
