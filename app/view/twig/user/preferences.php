                ...
                <div class="container-fluid container-limited">
                    <form class="row prepend-top-default js-preferences-form" id="user_setting"
                        ...
                        <div class="col-lg-8 syntax-theme">
                            <label><div class="preview"><img class="js-lazy-loaded" src="/gitlab/images/white-scheme-preview.png"></div>
                                <input type="radio" value="top" checked="checked" name="params[scheme_style]" id="scheme_top">
                                极简风格
                            </label><label><div class="preview"><img class="js-lazy-loaded" src="/gitlab/images/solarized-light-scheme-preview.png"></div>
...
<script src="/dev/js/user/preferences.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript">
    ...
    $(function() {
        var options = {
            ...
            get_url:"/user/getPreferences",
            update_url:"/user/setPreferences",
        }
