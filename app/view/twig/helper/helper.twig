<link rel="stylesheet" href="/dev/css/helper.css?v={{_version}}"/>
...
<div class="helper-btn animated js-key-help" id="helper-btn">
    <img class="helper-img" src="/dev/img/helper-img.png">
    ...
    <div class="card hide" id="detail_content"><!--详细内容-->
        <div class="detail">
            ...
            <div class="img-content"><!--2px白边-->
                <a href="/doc/images/login_01_thumb.png" target="_blank">
                    <img src="/doc/images/login_01_thumb.png" title="点击查看">
                </a>
            </div>
            <div class="fragment">
            ...
            <div class="img-content"><!--2px白边-->
                <a href="/doc/images/login_02_thumb.png" target="_blank">
                    <img src="/doc/images/login_02_thumb.png" title="点击查看">
                </a>
            </div>
            <div class="fragment">
                <h3>创建组织</h3>
            ...
            <div class="img-content"><!--2px白边-->
                <a href="/doc/images/org_01.png" target="_blank">
                    <img src="/doc/images/org_01.png" title="点击查看">
                </a>
            </div>
            <div class="fragment">
                <h3>创建项目</h3>
            ...
            <div class="img-content"><!--2px白边-->
                <a href="/doc/images/proj_01.png" target="_blank">
                    <img src="/doc/images/proj_01.png" title="点击查看">
                </a>
            </div>
            <div class="fragment">
                <h3>项目设置</h3>
            ...
            <div class="img-content"><!--2px白边-->
                <a href="/doc/images/issue_21.png" target="_blank">
                    <img src="/doc/images/issue_21.png" title="点击查看">
                </a>
                <a href="/doc/images/issue_22_thumb.png" target="_blank">
                    <img src="/doc/images/issue_22_thumb.png" title="点击查看">
                </a>
            </div>
            <div class="fragment">
                <h3>敏捷开发</h3>
            ...
            <div class="img-content"><!--2px白边-->
                <a href="/doc/images/sprints_05.png" target="_blank">
                    <img src="/doc/images/sprints_05.png" title="点击查看">
                </a>
            </div>
            <div class="fragment">
                <h4>跟踪和管理迭代</h4>
            ...
            <div class="img-content"><!--2px白边-->
                <a href="/doc/images/chart_01.png" target="_blank">
                    <img src="/doc/images/chart_01.png" title="点击查看">
                </a>
                <a href="/doc/images/chart_02_thumb.png" target="_blank">
                    <img src="/doc/images/chart_02_thumb.png" title="点击查看">
                </a>
            </div>
    ...
    <div class="card hide" id="contact-panel"><!--对话框-->
        <div class="top-part">
            ...
            <div class="img-group text-center">
                <div class="img-col">
                    <div class="img_item">
                        <img src="/dev/img/test-float-panel.png" alt="">
                    </div>
                </div>
                <div class="img-col">
                    <div class="img_item">
