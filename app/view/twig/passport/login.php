...
<head>
    {% include 'twig/common/header/include.php' %}
</head>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#refresh_login_vcode").click(function () {
            ...
            $("#img_login_vcode").attr('src', '/passport/output_captcha?mode=login' + '&' + timestamp);
        });

        $("#refresh_reg_vcode").click(function () {
            var timestamp = new Date().getTime();
            $("#img_reg_vcode").attr('src', '/passport/output_captcha?mode=reg' + '&' + timestamp);
        });
...
<div class="page-wrap">
    ...
    {% include 'twig/common/body/script.php' %}

    {% include 'twig/common/body/header.php' %}
    ...
    <div class="container navless-container">
        <div class="content">
            ...
            <div class="row">
                                        ...
                                        {% if captcha_login_switch %}
                                            ...
                                            <div>
                                                <img id="img_login_vcode"
                                                     src="/passport/output_captcha?mode=login&n=<?php echo rand(100, 999); ?>">
                                        ...
                                        {% if captcha_reg_switch %}
                                            ...
                                            <div>
                                                <img id="img_reg_vcode"
                                                     src="/passport/output_captcha?mode=reg&n=<?php echo rand(100, 999); ?>">
                ...
                {% include 'twig/common/body/brand-holder.php' %}
...
{% include 'twig/common/body/footer.php' %}
