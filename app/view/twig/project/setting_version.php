...
<head>
    ...
    <script src="/dev/js/project/version.js?v={{_version}}" type="text/javascript" charset="utf-8"></script>
        ...
        <div class="container-fluid container-limited">
            ...
            <div class="content" id="content-body">
                ...
                <div class="row prepend-top-default">
                    ...
                    <div class="col-lg-9">
                        <form id="form_add_action" class="setting-form clearfix" action="/project/version/add?project_id=<?=$project_id?>" accept-charset="UTF-8" method="post">
...
<script>
    ...
    $(function() {
        ...
        let options = {
            ...
            filter_url:"/project/version/filter_search?project_id=<?=$project_id?>"
        };
