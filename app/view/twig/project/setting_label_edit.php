        ...
        <div class="">
            <div class="content" id="content-body">
                ...
                <div class="container-fluid container-limited">
                    ...
                    <hr>
                    <form class="form-horizontal label-form js-quick-submit js-requires-input" id="form_edit_action" action="/project/label/update?project_id=<?=$project_id?>" accept-charset="UTF-8" method="post">
