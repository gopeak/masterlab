...
<head>
    ...
    <script src="/dev/js/admin/log_slow_sql.js?v={{_version}}" type="text/javascript" charset="utf-8"></script>
                    ...
                    <div class="top-area">
                        <ul class="nav-links" style="float:left">
                            <li class="active" data-value="">
                                <a id="state-opened" title="慢sql日志" href="/admin/log_operating/slow_sql"><span> 慢sql日志 </span>
                                </a>
                            </li>
                        </ul>
                        <div class="nav-controls row-fixed-content" style="float: left;margin-left: 80px">
                            <form id="log_filter_form" action="/admin/log_operating/slow_sql" accept-charset="UTF-8" method="get">
