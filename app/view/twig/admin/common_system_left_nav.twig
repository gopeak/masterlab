...
<!--                <li class="<?/* if($left_nav_active=='user_session') echo 'active';*/?>">
            ...
            <ul class="aui-nav" resolved="">
                ...
                <li class="<? if($left_nav_active=='email_notify_setting') echo 'active';?>">
                    <a href="/admin/system/email_notify_setting" id="email_notify_setting">邮件通知配置</a>
                </li>
            ...
            <ul class="aui-nav" resolved="">
                <li class="<? if($left_nav_active=='backup_data') echo 'active';?>">
                    <a href="/admin/system/backup_data" id="backup_data">备份系统数据</a>
                </li>
                <li class="<? if($left_nav_active=='restore_data') echo 'active';?>">
                    <a href="/admin/system/restore_data" id="restore_data">恢复系统数据</a>
                </li>
              <li>
...
<!--            <hr>
            ...
            <ul class="aui-nav" resolved="">
                <li>
                    <a href="/admin/system/cache"  class="<? if($left_nav_active=='system_cache') echo 'active';?>" id="system_cache">缓存</a>
                </li>
                <li>
            ...
            <ul class="aui-nav" resolved="">
                <li><a href="/admin/log_operating/index"  class="<? if($left_nav_active=='log_operating') echo 'active';?>" id="log_operating">操作日志</a></li>
               <!-- <li><a href="#" id="logging_profiling">日志和分析</a></li>-->
                <li><a href="/admin/log_operating/slow_sql" class="<? if($left_nav_active=='log_slow_sql') echo 'active';?>" id="log_slow_sql">Sql慢查询</a></li>
