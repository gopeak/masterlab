...
<head  >
    ...
    <script src="/dev/js/admin/issue_type_tpl.js?v={{_version}}" type="text/javascript" charset="utf-8"></script>
...
<div class="modal" id="modal-bind_issue_types">
    <form id="form-for_issue_types"
          ...
          action="/admin/user/bind_issue_types"
          accept-charset="UTF-8"
          method="post">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var options = {
            ...
            filter_url:"/admin/issue_desc_tpl/fetch_all",
            get_url:"/admin/issue_desc_tpl/get",
            update_url:"/admin/issue_desc_tpl/update",
            add_url:"/admin/issue_desc_tpl/add",
            delete_url:"/admin/issue_desc_tpl/delete",
            get_bind_url:"/admin/issue_desc_tpl/fetchBindIssueTypes",
            bind_url:"/admin/issue_desc_tpl/bindIssueTypes",
