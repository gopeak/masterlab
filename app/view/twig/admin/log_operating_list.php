...
<head>
    ...
    <script src="/dev/js/admin/log_operating.js?v={{_version}}" type="text/javascript" charset="utf-8"></script>
                    ...
                    <div class="col-lg-12">
                        <div class="top-area">
                            ...
                            <div class="nav-controls">
                                <form id="log_filter_form" action="/admin/log_base/index" accept-charset="UTF-8" method="get">
