...
<script id="assignee_my-body_tpl" type="text/html">
    ...
    <div id="assignee_my_more" class="assignee-more" style="display: none">
        <a href="/issue/main?sys_filter=assignee_mine" style="float: right"
           data-toggle="tooltip"
           data-placement="top"
           data-container="body"
...
<script id="assignee_my_tpl" type="text/html">
    ...
    <tr>
        ...
        <td><a href="/issue/detail/index/{{id}}">
		{{summary}}
        ...
        <div class="event-list-item-content">
            <h4 class="event-list-item-title">
                ...
                <span class="event">
                    ...
                    {{/if_eq}}
                    {{#if_eq type 'agile'}}
                        <a href="/default/ERP/sprints/{{obj_id}}">{{title}}</a>
                    {{/if_eq}}
                    {{#if_eq type 'issue'}}
                        <a href="/issue/detail/index/{{obj_id}}">{{title}}</a>
                    {{/if_eq}}
                    {{#if_eq type 'issue_comment'}}
                        <a href="/issue/detail/index/{{obj_id}}">{{title}}</a>
                    {{/if_eq}}
                    {{#if_eq type 'user'}}
                        <a href="/user/profile/{{user_id}}">{{title}}</a>
                    {{/if_eq}}
                    {{#if_eq type 'project'}}
                        <a href="/project/main/home/?project_id={{project_id}}">{{title}}</a>
                    {{/if_eq}}
                </span>
            </h4>
...
<script id="nav_tpl" type="text/html">
    <div class="link-group">
        <a href="/org/create">创建组织</a>
        <a href="/project/main/_new">创建项目</a>
        <a href="/issue/main/#create">创建事项</a>
