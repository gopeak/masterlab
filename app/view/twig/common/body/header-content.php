...
<!--            </div>-->
            ...
            {% include 'twig/common/body/header-logo.php' %}
            {% include 'twig/common/body/header-title-container.php' %}
            {% include 'twig/gitlab/common/body/header-dropdown.php' %}
...
{% include 'twig/common/announcement.php' %}
{% include 'twig/helper/helper.php' %}
