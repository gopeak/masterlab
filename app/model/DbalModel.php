 ...
 *  数据库操作模型基类
 */
class DbalModel extends BaseModel
{
    ...
    public function getRows($fields = "*", $conditions = [], $append = null, $orderBy = null, $sort = null, $limit = null, $primaryKey = false)
    {
        ...
        if ($primaryKey) {
            $rowsArr = array_column($rowsArr, null, $this->primaryKey);
        }
        if (!$rowsArr) {
            return [];
        }
    ...
    public function inc($field, $id, $primaryKey = 'id', $incValue = 1)
    {
        ...
        $ret = $this->db->executeUpdate($sql, $conditions);
        return $ret;
    }
