...
class AwardsHandler {
  ...
  // Then render the remaining category of emojis one by one to avoid jank.
  ...
  addRemainingEmojiMenuCategories() {
    ...
    // Avoid the jank and render the remaining category separately
    ...
    allCategoriesAddedPromise.then(() => {
      ...
      emojiContentElement.insertAdjacentHTML('beforeend', '<p>We encountered an error while adding the remaining category</p>');
