var Gantt = (function () {
    ...
    Gantt.prototype.moveUpCurrentIssue= function () {
            ...
            success: function (resp) {
                ...
                if (resp.data.roles.length) {
                    ...
                    $(".list_edit_perm").click(function () {
                        Gantt.prototype.permEdit($(this).data('id'), $(this).data('name'));
                    });

                    $(".list_add_user").click(function () {
                        Gantt.prototype.editRoleUser($(this).data("id"));
                    });

                    $(".list_for_edit").click(function () {
                        Gantt.prototype.edit($(this).data('id'));
                    });

                    $(".list_for_delete").click(function () {
                        Gantt.prototype._delete($(this).data("id"));
                    });
                } else {
                    defineStatusHtml({
    ...
    Gantt.prototype.edit = function (id) {
    ...
    Gantt.prototype.editRoleUser = function (id) {
            ...
            success: function (resp) {
                ...
                if (resp.ret == 200) {
                    ...
                    $(".role_user_remove").click(function () {
                        Gantt.prototype._deleteRoleUser($(this).data("id"), $(this).data("user_id"), $(this).data("project_id"), $(this).data("role_id"));
                    });
                } else {
                    notify_error("请求数据错误:" + resp.msg);
                }
    ...
    Gantt.prototype.addRoleUser = function () {
    ...
    Gantt.prototype.permEdit = function (id, name) {
    ...
    Gantt.prototype.updatePerm = function () {
    ...
    Gantt.prototype._delete = function (id) {
    ...
    Gantt.prototype._deleteRoleUser = function (id, user_id, project_id, role_id) {
        if (!window.confirm('您确认删除该项吗?')) {
            return false;
        }
