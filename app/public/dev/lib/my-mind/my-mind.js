...
MM.App = {
	...
	_syncPort: function () {
		...
		var padding = 40 + 32;
		this.portSize = [window.innerWidth - ui.offsetWidth - sideBar.offsetWidth - padding, window.innerHeight - navbar.offsetHeight - navControl.offsetHeight - mindTools.offsetHeight - 40];
