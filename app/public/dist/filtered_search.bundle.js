...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DATA_TRIGGER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return DATA_DROPDOWN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return SELECTED_CLASS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return ACTIVE_CLASS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return IGNORE_CLASS; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__drop_down__ = __webpack_require__(20);
/* eslint-disable */
...
var Hook = function(trigger, list, plugins, config){
  ...
  this.list = new __WEBPACK_IMPORTED_MODULE_0__drop_down__["a" /* default */](list);
  this.type = 'Hook';
  this.event = 'click';
...
const utils = {
  ...
  isDropDownParts(target) {
    ...
    return target.hasAttribute(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* DATA_TRIGGER */]) || target.hasAttribute(__WEBPACK_IMPORTED_MODULE_0__constants__["e" /* DATA_DROPDOWN */]);
  },
};
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(9), __webpack_require__(4), __webpack_require__(33).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__droplab_plugins_filter__ = __webpack_require__(7);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__droplab_plugins_ajax__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__droplab_plugins_filter__ = __webpack_require__(7);
/* global Flash */
...
(() => {
  class DropdownNonUser extends gl.FilteredSearchDropdown {
    ...
    renderContent(forceShowList = false) {
      this.droplab
        .changeHookList(this.hookId, this.dropdown, [__WEBPACK_IMPORTED_MODULE_0__droplab_plugins_ajax__["a" /* default */], __WEBPACK_IMPORTED_MODULE_1__droplab_plugins_filter__["a" /* default */]], this.config);
      super.renderContent(forceShowList);
    }

    init() {
      this.droplab
        .addHook(this.input, this.dropdown, [__WEBPACK_IMPORTED_MODULE_0__droplab_plugins_ajax__["a" /* default */], __WEBPACK_IMPORTED_MODULE_1__droplab_plugins_filter__["a" /* default */]], this.config).init();
    }
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__droplab_plugins_ajax_filter__ = __webpack_require__(26);
/* global Flash */
...
(() => {
  class DropdownUtils {
    ...
    static getSearchQuery(untilInput = false) {
      const container = __WEBPACK_IMPORTED_MODULE_0__container__["a" /* default */].container;
      ...
      tokens.forEach((token) => {
        if (token.classList.contains('js-visual-token')) {
          ...
          const input = __WEBPACK_IMPORTED_MODULE_0__container__["a" /* default */].container.querySelector('.filtered-search');
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__droplab_drop_lab__ = __webpack_require__(21);
...
(() => {
  class FilteredSearchDropdownManager {
    ...
    static addWordToInput(tokenName, tokenValue = '', clicked = false) {
      const input = __WEBPACK_IMPORTED_MODULE_1__container__["a" /* default */].container.querySelector('.filtered-search');
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__container__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__recent_searches_root__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stores_recent_searches_store__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_recent_searches_service__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__event_hub__ = __webpack_require__(3);
/* global Flash */
  ...
  class FilteredSearchManager {
    constructor(page) {
      ...
      if (this.filteredSearchInput) {
        ...
        this.recentSearchesRoot = new __WEBPACK_IMPORTED_MODULE_1__recent_searches_root__["a" /* default */](
...
class FilteredSearchVisualTokens {
  static getLastVisualTokenBeforeInput() {
    const inputLi = __WEBPACK_IMPORTED_MODULE_0__container__["a" /* default */].container.querySelector('.input-token');
  ...
  static unselectTokens() {
    const otherTokens = __WEBPACK_IMPORTED_MODULE_0__container__["a" /* default */].container.querySelectorAll('.js-visual-token .selectable.selected');
  ...
  static removeSelectedToken() {
    const selected = __WEBPACK_IMPORTED_MODULE_0__container__["a" /* default */].container.querySelector('.js-visual-token .selected');
  ...
  static addVisualTokenElement(name, value, isSearchTerm) {
    ...
    const tokensContainer = __WEBPACK_IMPORTED_MODULE_0__container__["a" /* default */].container.querySelector('.tokens-container');
    const input = __WEBPACK_IMPORTED_MODULE_0__container__["a" /* default */].container.querySelector('.filtered-search');
  ...
  static moveInputToTheRight() {
    const input = __WEBPACK_IMPORTED_MODULE_0__container__["a" /* default */].container.querySelector('.filtered-search');
    const inputLi = input.parentElement;
    const tokenContainer = __WEBPACK_IMPORTED_MODULE_0__container__["a" /* default */].container.querySelector('.tokens-container');
...
Object.assign(DropDown.prototype, {
  ...
  clickEvent: function(e) {
    ...
    if (e.target.classList.contains(__WEBPACK_IMPORTED_MODULE_1__constants__["c" /* IGNORE_CLASS */])) return;

    var selected = __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* default */].closest(e.target, 'LI');
    if (!selected) return;
  ...
  addSelectedClass: function (selected) {
    ...
    selected.classList.add(__WEBPACK_IMPORTED_MODULE_1__constants__["d" /* SELECTED_CLASS */]);
  },

  removeSelectedClasses: function () {
    const items = this.items || this.getItems();

    items.forEach(item => item.classList.remove(__WEBPACK_IMPORTED_MODULE_1__constants__["d" /* SELECTED_CLASS */]));
  },
  ...
  renderChildren: function(data) {
    var html = __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* default */].t(this.templateString, data);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hook_button__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hook_input__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__keyboard__ = __webpack_require__(24);
...
Object.assign(DropLab.prototype, {
  loadStatic: function(){
    var dropdownTriggers = [].slice.apply(document.querySelectorAll(`[${__WEBPACK_IMPORTED_MODULE_4__constants__["a" /* DATA_TRIGGER */]}]`));
  ...
  documentClicked: function(e) {
    ...
    if (thisTag.tagName !== 'UL') thisTag = __WEBPACK_IMPORTED_MODULE_2__utils__["a" /* default */].closest(thisTag, 'UL');
    if (__WEBPACK_IMPORTED_MODULE_2__utils__["a" /* default */].isDropDownParts(thisTag, this.hooks) || __WEBPACK_IMPORTED_MODULE_2__utils__["a" /* default */].isDropDownParts(e.target, this.hooks)) return;
  ...
  addHook: function(hook, list, plugins, config) {
    ...
    if (typeof list === 'string') {
      ...
      availableList = document.querySelector(hook.dataset[__WEBPACK_IMPORTED_MODULE_2__utils__["a" /* default */].toCamelCase(__WEBPACK_IMPORTED_MODULE_4__constants__["a" /* DATA_TRIGGER */])]);
    }

    availableList.dataset.dropdownActive = true;

    const HookObject = availableHook.tagName === 'INPUT' ? __WEBPACK_IMPORTED_MODULE_1__hook_input__["a" /* default */] : __WEBPACK_IMPORTED_MODULE_0__hook_button__["a" /* default */];
  ...
  init: function (hook, list, plugins, config) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__keyboard__["a" /* default */])();
...
/* harmony default export */ __webpack_exports__["a"] = (DropLab);
...
var HookButton = function(trigger, list, plugins, config) {
  __WEBPACK_IMPORTED_MODULE_0__hook__["a" /* default */].call(this, trigger, list, plugins, config);
...
HookButton.prototype = Object.create(__WEBPACK_IMPORTED_MODULE_0__hook__["a" /* default */].prototype);
...
/* harmony default export */ __webpack_exports__["a"] = (HookButton);
...
/* harmony default export */ __webpack_exports__["a"] = (HookInput);
...
const Keyboard = function () {
  ...
  var removeHighlight = function removeHighlight(list) {
    ...
    for(var i = 0; i < itemElements.length; i++) {
      ...
      listItem.classList.remove(__WEBPACK_IMPORTED_MODULE_0__constants__["b" /* ACTIVE_CLASS */]);
  ...
  var setMenuForArrows = function setMenuForArrows(list) {
    ...
    if(list.currentIndex>0){
      ...
      if (listItems[list.currentIndex-1]) {
        ...
        el.classList.add(__WEBPACK_IMPORTED_MODULE_0__constants__["b" /* ACTIVE_CLASS */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__event_hub__ = __webpack_require__(3);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_recent_searches_dropdown_content__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__event_hub__ = __webpack_require__(3);
...
class RecentSearchesRoot {
  ...
  render() {
    this.vm = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
