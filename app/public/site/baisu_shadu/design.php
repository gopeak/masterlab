    ...
    <div class="row flex-xl-nowrap">
        <div class="menu bd-sidebar drawer">
            <div class="inner">
                ...
                <ul class="list-group">
                    <li class="list-group-item active"><a href="./design.php">设计原则</a></li>
                    <li class="list-group-item "><a href="./color.php">色彩</a></li>
        ...
        <div class="detail content">
            <div class="toc-container" style="position: absolute;">
                <div class="toc">
                    <ul class="toc-list ">
                        <li class="toc-list-item"><a href="#_数据可视化设计原则" class="toc-link node-name--H1  is-active-link">数据可视化设计原则</a>
                            <ul class="toc-list ">
                                <li class="toc-list-item"><a href="#_准确" class="toc-link node-name--H3 ">准确</a>
                                    <ul class="toc-list  is-collapsible is-collapsed">
                                        <li class="toc-list-item"><a href="#_有效" class="toc-link node-name--H3 ">有效</a>
                                        </li>
                                        <li class="toc-list-item"><a href="#_清晰" class="toc-link node-name--H3 ">清晰</a>
                                        </li>
                                        <li class="toc-list-item"><a href="#_美" class="toc-link node-name--H3 ">美</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
            ...
            <article><h1 id="_数据可视化设计原则"><a href="#_数据可视化设计原则" class="anchor"></a>数据可视化设计原则</h1>
                <p>数据可视化设计原则是基于 <a href="https://docs.gitlab.com/ee/development/ux_guide/features.html">Gitlab 和 Ant Design</a>
                    设计体系衍生的，具有数据可视化特性的指导原则。它遵循 Gitlab 和 Ant Design 设计价值观的同时，对数据可视化领域的进一步解读，如色彩、字体的指引。</p>
                <blockquote>
                    <p>注：Ant Design 是一个致力于提升『用户』和『设计者』使用体验的中台设计语言。它将进行 UE 设计和 UI
                        设计人员统称为『设计者』，利用统一的规范进行设计赋能，全面提高中台产品体验和研发效率。</p>
                </blockquote>
                <p>我们经过大量的项目实践和经验总结，总结了以下四条核心原则，并以重要等级进行排序，四条原则相辅相成且呈递进关系，希望你在设计时也可以采纳。</p>
                <h3 id="_准确"><a href="#_准确" class="anchor"><span
                                class="iconfont icon-link"></span></a><strong>准确</strong></h3>
                <p>从数据转化到可视表达时不歪曲，不误导，不遗漏，忠实反映数据里包含的信息。</p>
                <h3 id="_有效"><a href="#_有效" class="anchor"><span
                                class="iconfont icon-link"></span></a><strong>有效</strong></h3>
                <p>信息传达有重点，克制不冗余，避免信息过载，用最适量的数据-油墨比 <sup class="footnote-ref"></sup>表达对用户最有用的信息。
                </p>
                <h3 id="_清晰"><a href="#_清晰" class="anchor"><span
                                class="iconfont icon-link"></span></a><strong>清晰</strong></h3>
                <p>表现方式清楚易读，具条理性，可以帮助用户快速达成目标，在最少的时间内获取更多的信息。</p>
                <h3 id="_美"><a href="#_美" class="anchor"><span class="iconfont icon-link"></span></a><strong>美</strong>
                </h3>
                <p>对数据的完美表达，合理利用视觉元素进行艺术创作，不过度修饰，给用户优雅的体验。</p>

                <div class="prev-next"><a href="./color.php" class="float-right next">色彩</a></div>
            </article>
        </div>
    </div>
</div>
