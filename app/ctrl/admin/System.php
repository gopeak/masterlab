...
class System extends BaseAdminCtrl
{
    ...
    public function pageBasicSettingEdit()
    {
        ...
        $data['sub_nav_active'] = 'setting';
        $data['left_nav_active'] = 'setting';
        $this->render('twig/admin/system_basic_setting_form.php', $data);
    }
    ...
    public function globalPermission()
    {
        ...
        $this->render('twig/admin/system_global_permission.php', $data);
    }
    ...
    public function pagePasswordStrategy()
    {
        ...
        $this->render('twig/admin/system_password_strategy.php', $data);
    }
    ...
    public function pageUserSession()
    {
        ...
        $this->render('twig/admin/system_user_session.php', $data);
    }
    ...
    public function pageDatetimeSetting()
    {
        ...
        $this->render('twig/admin/system_datetime_setting.php', $data);
    }
    ...
    public function pageAttachmentSetting()
    {
        ...
        $this->render('twig/admin/system_attachment_setting.php', $data);
    }
    ...
    public function pageUiSetting()
    {
        ...
        $this->render('twig/admin/system_ui_setting.php', $data);
    }
    ...
    public function pageUserDefaultSetting()
    {
        ...
        $this->render('twig/admin/system_user_default_setting.php', $data);
    }
    ...
    public function pageCache()
    {
        ...
        $this->render('twig/admin/system_cache.php', $data);
    }
    ...
    public function pageAnnouncement()
    {
        ...
        $this->render('twig/admin/system_announcement.php', $data);
    }
    ...
    public function pageSmtpConfig()
    {
        ...
        $this->render('twig/admin/system_smtp_config.php', $data);
    }
    ...
    public function pageEmailQueue()
    {
        ...
        $this->render('twig/admin/system_email_queue.php', $data);
    }
    ...
    public function pageSendMail()
    {
        ...
        $this->render('twig/admin/system_send_mail.php', $data);
    }
    ...
    public function pageEmailNotifySetting()
    {
        ...
        $this->render('twig/admin/system_email_notify_setting.php', $data);
    }
    ...
    public function pageBackupData()
    {
        ...
        $this->render('twig/admin/system_backup_data.php', $data);
    }
    ...
    public function pageRestoreData()
    {
        ...
        $this->render('twig/admin/system_restore_data.php', $data);
    }
}
