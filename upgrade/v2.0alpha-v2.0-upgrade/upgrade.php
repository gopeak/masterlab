<?php
/**
 * Masterlab v2.0 alpha 升级到 v2.0 升级补丁
...
// 数据库补丁文件路径，要求sql格式
$sqlFile = $currentDir . 'data' . DIRECTORY_SEPARATOR . 'v2.0alpha-2.0.sql';

// 索引操作语句SQL文件
$indexSqlFile = $currentDir . 'data' . DIRECTORY_SEPARATOR . 'v2.0alpha-2.0_index.sql';

// 代码补丁压缩包路径，要求zip格式
$patchFile = $currentDir . 'data' . DIRECTORY_SEPARATOR . 'v2.0alpha-2.0.patch.zip';
